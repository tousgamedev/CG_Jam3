...
namespace Movement
{
    public class FlightController : ControllerBase
    {
        ...
        [SerializeField] private EngineEffects engineEffects;
        [SerializeField] private EngineEffects boostEffects;
        ...
        private void UpdateBoost(float deltaTime)
        {
            ...
            PlayerCanvas.Instance.Status.SetBoost(currentBoostDuration / afterburnerDuration[afterburnerIndex]);
        }

        private void SetThrusterColor(float boostProgress)
        {
            Color currentMainColor = Color.Lerp(engineEffects.primaryColor, boostEffects.primaryColor, boostProgress);
            Color currentHighlightColor = Color.Lerp(engineEffects.secondaryColor, boostEffects.secondaryColor, boostProgress);
